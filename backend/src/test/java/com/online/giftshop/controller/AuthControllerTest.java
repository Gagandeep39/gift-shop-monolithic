...
public class AuthControllerTest {
  ...
  void validateAnswerAndUpdatePasswordInvalidUsername() throws Exception {
    ...
    mockMvc.perform(MockMvcRequestBuilders.put("/auth/forgotpassword").contentType(MediaType.APPLICATION_JSON)
        .content(mapper.writeValueAsString(forgotPasswordRequest))).andExpect(status().is4xxClientError());
  }
